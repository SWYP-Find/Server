...
public interface ScenarioRepository extends JpaRepository<Scenario, UUID> {
    ...
    Optional<Scenario> findWithDetailsById(@Param("id") UUID id);

    Optional<Scenario> findByBattleIdAndStatus(UUID battleId, ScenarioStatus status);
    boolean existsByBattleId(UUID battleId);
}