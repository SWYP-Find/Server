 ...
 *
 * 두 잡을 순차로 돌린다:
 *   1) 다수결 보상 (+5P)  — 2주 전 배틀, 총 투표수 ≥ 10 인 건의 승수 옵션 투표자 전원
 *   2) 베댓 보상    (+15P) — 2주 전 배틀의 Perspective 좋아요 1위 작성자
 *
 * 동일 스냅샷 윈도우(14~20일 전 targetDate)를 공유한다.
 * 각 잡의 referenceId 가 결정적(배틀ID / perspectiveID)이므로
